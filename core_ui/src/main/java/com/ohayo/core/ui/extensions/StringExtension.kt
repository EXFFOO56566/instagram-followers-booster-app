...
import com.ohayo.core.ui.helper.CustomTypefaceSpan
...
fun SpannableStringBuilder.setClickableSpan(start: Int,
                                            end: Int,
                                            onClickListener: (() -> Unit)? = null,
                                            updateDrawStateBlock: ((TextPaint) -> Unit)? = null): SpannableStringBuilder {
    setSpan(
